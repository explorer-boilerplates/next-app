...
We can distinguish 3 different approaches when preparing type scale for different device widths.

### First Approach - Do nothing

In the first approach you don't change type scale across your breakpoints. Without scaling your typography to different breakpoints your headings may be too small for large screens or too big for smaller screens. Usually you would want to adjust your scale to the device your user is using.

### Second Approach - Just Increace your type scale by one.

In this approach you just increace your type scale by one for every breakpoint (or only for some breakpoints). For example. Let's say you are using Major Second (1.125) breakpoint.
...
### Third Approach - use different type scale.
...
Special thanks for the creators of this articles. This section was inspired by them:
